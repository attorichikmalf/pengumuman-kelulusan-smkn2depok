...
| The auto-detection mechanism exists only
 for convenience during
...
$config['admin_login_path'] = 'admin/auth/login'; // Bisa diganti sesuai keinginan
$config['admin_login_token'] = 'kelulusan';
